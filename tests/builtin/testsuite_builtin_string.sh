...
echo -e "$TURQUOISE Tests BUILTIN STRING"
echo -e "$TURQUOISE =========================================================="
...
# ============================= Test STRING ==================================
# EXIT
run_test_string "exit"
run_test_string "exit uwu"
run_test_string "exit 42"
run_test_string "exit -42"
run_test_string "if true; then exit 45; else echo toto; fi"

# CD
run_test_string 'cd; echo $PWD'
run_test_string 'cd ..; echo $PWD'
run_test_string 'cd uwu; echo $PWD'

# UNSET
run_test_string 'tata=toto; unset tata; echo $tata'
run_test_string 'tata=toto; unset tat; echo $tata'
