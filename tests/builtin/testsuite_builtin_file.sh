...
echo -e "$TURQUOISE Tests BUILTIN FILE"
echo -e "$TURQUOISE =========================================================="
...
# EXIT
run_test_file "exit"
run_test_file "exit uwu"
run_test_file "exit 42"
run_test_file "exit -42"
run_test_file "if true; then exit 45; else echo toto; fi"

# CD
run_test_file 'cd; echo $PWD'
run_test_file 'cd ..; echo $PWD'
run_test_file 'cd uwu; echo $PWD'

# UNSET
run_test_file 'tata=toto; unset tata; echo $tata'
run_test_file 'tata=toto; unset tat; echo $tata'
