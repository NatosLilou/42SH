...
echo -e "$TURQUOISE Tests BUILTIN INPUT"
echo -e "$TURQUOISE =========================================================="
...
# EXIT
run_test_input "exit"
run_test_input "exit uwu"
run_test_input "exit 42"
run_test_input "exit -42"
run_test_input "if true; then exit 45; else echo toto; fi"

# CD
run_test_input 'cd; echo $PWD'
run_test_input 'cd ..; echo $PWD'
run_test_input 'cd uwu; echo $PWD'

# UNSET
run_test_input 'tata=toto; unset tata; echo $tata'
run_test_input 'tata=toto; unset tat; echo $tata'
