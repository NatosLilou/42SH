...
echo -e "$TURQUOISE=================== Tests AND OR INPUT ====================="
...
# ============================== Test INPUT  ===================================
run_test_input "true && false || true"
run_test_input "true && false && false"
run_test_input "true || false"
run_test_input "echo toto || true"
run_test_input "true && echo toto || echo false"
