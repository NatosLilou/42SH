...
echo -e "$TURQUOISE=================== Tests PIPELINE INPUT ==================="
...
# ============================== Test INPUT =================================
run_test_input "echo hebbo | tr e a | tr b l"
run_test_input "echo hello toto | false | tr o u"
run_test_input "echo toto | true"
run_test_input "echo tata | ls -a | echo tonton"
run_test_input "ls -l | git status"
