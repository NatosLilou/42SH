...
echo -e "$TURQUOISE Tests FOR REDIR"
echo -e "$TURQUOISE =========================================================="
...
run_test_redir "for i; do echo toto; done"
run_test_redir "for i in toto tata; do echo toto; done"
run_test_redir 'for i toto tata; do echo $i; done'
run_test_redir 'for i toto tata; do if $i; then echo uwu; else echo yamete; fi; done'
