...
echo -e "$TURQUOISE Tests IF INPUT"
echo -e "$TURQUOISE =========================================================="
...
# ============================== Test INPUT ===================================
# if - then - else
run_test_input "if true ; then echo foo ; else echo bar ; fi"
run_test_input "if true ; then echo true ;else echo bar; fi"
run_test_input "if false ; then echo foo bar ;else echo zoubir ;fi"
run_test_input "if if true; then echo uwu; fi;then echo jambon;fi"
run_test_input "if if false; then echo uwu; fi;then echo jambon;fi"

# if - elif
run_test_input "if false;then echo true ; elif false; then echo true;else echo jambon;fi"
