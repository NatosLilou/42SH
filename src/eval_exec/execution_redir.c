...
static int redir_great_simple(struct ast_redir *ast, struct ast_simple_command *arbre)
{
...
static int redir_dgreat_simple(struct ast_redir *ast, struct ast_simple_command *arbre)
{
    int stdout_dup = dup(ast->ionumber);
...
static int redir_less_simple(struct ast_redir *ast, struct ast_simple_command *arbre)
{
    int stdout_dup = dup(ast->ionumber);
...
int redir_lessgreat_simple(struct ast_redir *ast, struct ast_simple_command *arbre)
{
    int stdout_dup = dup(ast->ionumber);
...
static int redir_lessand_simple(struct ast_redir *ast, struct ast_simple_command *arbre)
{
...
static int redir_greatand_simple(struct ast_redir *ast, struct ast_simple_command *arbre)
{
    int fd = atoi(ast->dest);
    int stdout_dup = dup(ast->ionumber);
    if(dup2(fd, ast->ionumber) == -1)
